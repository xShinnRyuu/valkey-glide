...
class TestScripts:
    ...
    async def test_hexpiretime(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise an error
        with pytest.raises(RequestError, match="wrong number of arguments"):
            await glide_client.hexpiretime(key, [])
    ...
    async def test_hpexpiretime(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise an error
        with pytest.raises(RequestError, match="wrong number of arguments"):
            await glide_client.hpexpiretime(key, [])
    ...
    async def test_hexpire(self, glide_client: TGlideClient):
        ...
        with pytest.raises(RequestError):
            await glide_client.hexpire(key, 10, [])
    ...
    async def test_hpexpire(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise error
        with pytest.raises(RequestError, match="wrong number of arguments"):
            await glide_client.hpexpire(key, 10000, [])
    ...
    async def test_hexpireat(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise error
        with pytest.raises(RequestError):
            await glide_client.hexpireat(key, future_timestamp, [])
    ...
    async def test_hpexpireat(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise error
        with pytest.raises(RequestError, match="wrong number of arguments"):
            await glide_client.hpexpireat(key, future_timestamp_ms, [])
    ...
    async def test_hpersist(self, glide_client: TGlideClient):
        ...
        # Test with empty fields list - should raise error
        with pytest.raises(RequestError, match="wrong number of arguments"):
            await glide_client.hpersist(key, [])
